...
export function MilestoneClusterChip({ cluster, density, onClick }: MilestoneClusterChipProps) {
  ...
  return (
    <button
      ...
      className="absolute overflow-hidden rounded-[0.95rem] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(246,243,237,0.8))] px-3 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.92),0_8px_18px_rgba(15,23,42,0.045)] backdrop-blur-xl transition duration-200 hover:-translate-y-0.5 hover:border-[hsl(var(--accent))]/22 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.96),0_12px_24px_rgba(15,23,42,0.065)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))]"
      style={{
        width: cluster.width,
